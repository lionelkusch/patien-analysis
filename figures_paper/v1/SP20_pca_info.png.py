...
ax.set_title('explain variance', {"fontsize": label_size})
...
ax.set_title('explain variance cumulative', {"fontsize": label_size})

plt.subplots_adjust(left=0.05, right=0.99, top=0.93, bottom=0.05)
plt.savefig('figure/SP_20_pca_cumulative.png')
plt.show()
