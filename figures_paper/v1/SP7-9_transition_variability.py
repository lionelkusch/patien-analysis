...
plt.subplots_adjust(top=1.0, bottom=0.0, left=0.03, right=0.97)
plt.savefig('figure/SP_7_transition_all_variability.png')
...
ax1.set_xticklabels([])
ax1.set_xlabel('# cluster', {"fontsize": label_size})
ax1.set_ylabel('# cluster', {"fontsize": label_size})
...
plt.savefig('figure/SP_8_transition_significatif.png')
...
plt.savefig('figure/SP_9_transition_patient.png')
