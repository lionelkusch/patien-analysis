...
plt.subplot(3, 2, 1)
plt.plot(np.flip(range_i), result_data)
...
plt.title('normalized data (euclidean)')
...
plt.title('avalanches (euclidean)')
...
plt.title('avalanches pattern (cosine)')

plt.subplots_adjust(left=0.11, right=0.94, top=0.96, bottom=0.07, wspace=0.3, hspace=0.4)
plt.savefig('figure/SP_21_distance_data.png')
plt.show()
