...
from pipeline_phate_clustering.functions_helper.plot_brain import multiview_matplot, get_region_select, get_brain_mesh
...
multiview_matplot(axs10, vertices, lhfaces, rhfaces, region_map, cluster_vector[0], cmap=cmap_brain, shaded=shaded, region_select=region_selects)
...
multiview_matplot(axs11, vertices, lhfaces, rhfaces, region_map, cluster_vector[1], cmap=cmap_brain, shaded=shaded, region_select=region_selects)
...
multiview_matplot(axs12, vertices, lhfaces, rhfaces, region_map, cluster_vector[2], cmap=cmap_brain, shaded=shaded, region_select=region_selects)
...
multiview_matplot(axs13, vertices, lhfaces, rhfaces, region_map, cluster_vector[3], cmap=cmap_brain, shaded=shaded, region_select=region_selects)
...
multiview_matplot(axs14, vertices, lhfaces, rhfaces, region_map, cluster_vector[4], cmap=cmap_brain, shaded=shaded, region_select=region_selects)
...
multiview_matplot(axs15, vertices, lhfaces, rhfaces, region_map, cluster_vector[5], cmap=cmap_brain, shaded=shaded, region_select=region_selects)
...
multiview_matplot(axs16, vertices, lhfaces, rhfaces, region_map, cluster_vector[6], cmap=cmap_brain, shaded=shaded, region_select=region_selects)
...
plt.savefig('figure/figure_2_b_pre.png')
plt.show()
