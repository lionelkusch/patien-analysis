...
ax.set_ylabel('transition significance between 2 clusters (1 in and 1 out)', fontdict={"fontsize": label_size})
plt.subplots_adjust(left=0.05, right=1., top=0.99, bottom=0.07)
plt.savefig('figure_3/SP_15_order_transition.png', dpi=600)
