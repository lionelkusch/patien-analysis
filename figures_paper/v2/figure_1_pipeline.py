...
ax1.set_xticklabels([0, int((range_time[1]-range_time[0])/2), (range_time[1]-range_time[0])])
...
ax1.set_title('Reconstructed source normalised\nMEG signals', {"fontsize": label_size})
...
ax3.set_title('Avalanche patterns', {"fontsize": label_size}, pad=15)
...
im_transition = ax7.imshow(transitions*100)
...
colorbar_transition.ax.set_ylabel('% of transitions', {"fontsize": label_size}, labelpad=2)
...
plt.savefig('figure_3/figure_1_pre_pipeline.png')
plt.savefig('figure_3/figure_1_pre_pipeline.svg')
plt.savefig('figure_3/figure_1_pre_pipeline.eps')
plt.savefig('figure_3/figure_1_pre_pipeline.tiff', dpi=800)
plt.show()