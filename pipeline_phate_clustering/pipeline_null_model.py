...
def null_model_data(path_saving, avalanches_path=None,
    ...
    for nb_rand in range(nb_randomize):
        ...
        if update_transition or not os.path.exists(path_saving + "/"+str(nb_rand)+"_transition.npy"):
            ...
            cluster_patient_data = np.load(path_saving + "/"+str(nb_rand)+"_cluster_patient_data.npy", allow_pickle=True)
...
# null_model_transition(path_saving="/home/kusch/Documents/project/patient_analyse/paper/result/default/", plot_save=True)
# null_model_cluster_regions(path_saving="/home/kusch/Documents/project/patient_analyse/paper/result/default/", plot_save=True)
null_model_data(path_saving="/home/kusch/Documents/project/patient_analyse/paper/result/default/", avalanches_path=None,
             PHATE_n_pca=5, PHATE_knn=5, PHATE_decay=1.0, PHATE_knn_dist='cosine',
             PHATE_gamma=-1.0, PHATE_mds_dist='cosine', PHATE_n_components=3, PHATE_n_jobs=-1,
             kmeans_nb_cluster=5, kmeans_seed=123, plot=True, plot_save=True,
             update_Phate=False, update_transition=True,
             nb_randomize=100, seed=123)
