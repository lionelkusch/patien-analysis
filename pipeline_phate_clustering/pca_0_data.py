...
plt.savefig(path_data+'/../paper/result/PCA/data/pca_info.svg')
plt.figure()
plt.plot(np.arange(1, 91, 1), pca.explained_variance_ratio_, alpha=0.5)
plt.plot(np.arange(1, 91, 1), pca.explained_variance_ratio_, 'x')
plt.vlines(pca_choice, ymin=0.0, ymax=pca.explained_variance_ratio_[pca_choice-1], color='r', alpha=0.5)
plt.hlines(pca.explained_variance_ratio_[pca_choice-1], xmin=1, xmax=pca_choice, color='r', alpha=0.5)
plt.yscale("log")
plt.savefig(path_data+'/../paper/result/PCA/data/pca_info_log.svg')
plt.figure()
...
plt.savefig(path_data+'/../paper/result/PCA/data/pca_cumulative.svg')
# plt.show()
...
io.savemat(path_data + '/../paper/result/PCA/data/vector_cluster.mat',
           {'cluster_vector':np.concatenate([clusters_vectors])}
           )

plot_figure_2D(PCA_fit, '', cluster)
plt.savefig(path_data+'/../paper/result/PCA/data/PCA_cluster_in_2D.png')
plot_figure_2D_patient(PCA_fit, '', data)
plt.savefig(path_data+'/../paper/result/PCA/data/PCA_cluster_for_patient.png')
plot_figure_2D_patient_unique(PCA_fit, '', data)
plt.savefig(path_data+'/../paper/result/PCA/data/PCA_cluster_for_patient_unique.png')
plot_figure_2D_patient_unique_time(PCA_fit, '', data)
plt.savefig(path_data+'/../paper/result/PCA/data/PCA_cluster_for_patient_time.png')
plot_figure_2D_3D(PCA_fit, '', cluster)
plt.savefig(path_data+'/../paper/result/PCA/data/PCA_cluster_3D.png')
plt.close('all')
