...
def multiview_pyvista(axs, vertices, lhfaces, rhfaces, region_map, data, region_select=None, cmap='viridis', clim=None):
    ...
    p.add_mesh(mesh, cmap=cmap, clim=clim)
    p.view_xy()
    ...
    p2.add_mesh(mesh_left, cmap=cmap, clim=clim)
    p2.view_yz()
    ...
    p3.add_mesh(mesh_left, cmap=cmap, clim=clim)
    ...
    p4.add_mesh(mesh_right, cmap=cmap, clim=clim)
    p4.view_yz()
    ...
    p5.add_mesh(mesh_right, cmap=cmap, clim=clim)
