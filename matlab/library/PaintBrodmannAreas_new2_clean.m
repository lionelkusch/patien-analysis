function [cbh, patch_handles]=PaintBrodmannAreas_new2_clean(labels, data, nr_ROIs_to_plot, nr_colors_to_plot, nr_views, colour_range, colourbar_threshold, mesh_type, mesh_labels);
...
switch mesh_type
    case 'spm_canonical'
        switch mesh_labels
            case 'AAL'
                if exist('/home/kusch/Documents/project/patient_analyse/matlab/library/cortex_20484.surf.gii_labelled_lh.mat','file')
                    tmp = load('/home/kusch/Documents/project/patient_analyse/matlab/library/cortex_20484.surf.gii_labelled_lh.mat');
...
switch mesh_type
    case 'spm_canonical'
        switch mesh_labels
            case 'AAL'
                if exist('/home/kusch/Documents/project/patient_analyse/matlab/library/cortex_20484.surf.gii_labelled_rh.mat','file')
                    tmp = load('/home/kusch/Documents/project/patient_analyse/matlab/library/cortex_20484.surf.gii_labelled_rh.mat');
                else,  % for compiled files
                    try
                        ...
                        % for Windows (AH)
                        tmp=load('/home/kusch/Documents/project/patient_analyse/matlab/cortex_20484.surf.gii_labelled_rh.mat');
                    end
                end
            case 'BNA'
                try
...
set(cbh,'Position', [0.01,0.025,0.98,0.027])
%zoom(1.5)
